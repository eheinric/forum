...
/**
 * This file contains the moodle hooks for the submission forum plugin
 *
 ...
 */
function assignsubmission_forum_pluginfile($course, $cm, context $context, $filearea, $args, $forcedownload) {
    global $USER, $DB;
    ...
    $fullpath = "/{$context->id}/assignsubmission_forum/$filearea/$itemid/$relativepath";
